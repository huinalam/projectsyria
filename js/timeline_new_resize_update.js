...
function customAxis(g) {
  g.selectAll("text")
    ...
    d3.csv("data/event_summary_df.csv", function(data){ 
    ...
    d3.csv("data/groups.csv", function(data){ 
            ...
            var IS_g = involved_g.append("g")
                                ...
                                .attr("r",function(d){
                                    return rScale_group(d.IS);
                                })
                                .attr("id","IS");

            var RS_g = involved_g.append("g")
                                .attr("transform","translate(99,0)")
                                .selectAll("circle")
                                .data(data)
                                .enter()
                                ...
                                .attr("r",function(d){
                                    return rScale_group(d.RS);
                                })
                                .attr("id","RS");

            var US_g = involved_g.append("g")
                                .attr("transform","translate(132,0)")
                                .selectAll("circle")
                                .data(data)
                                .enter()
                                ...
                                .attr("r",function(d){
                                    return rScale_group(d.US);
                                })
                                .attr("id","US");

            var HZB_g = involved_g.append("g")
                                .attr("transform","translate(165,0)")
                                .selectAll("circle")
                                .data(data)
                                .enter()
